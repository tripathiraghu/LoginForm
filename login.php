...
<button  type="submit" class="btn " style="width:100%; background-color:#73f1ff; margin-top:10px;">SignIn</button>
 ...
 <!-- form ends here -->
<button  onclick="window.location.href = 'signup.php';" type="submit" class="btn " style="width:100%; background-color:#73f1ff; margin-top:20px;" >Not a memeber? SignUp</button>
